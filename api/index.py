        ...
        <head>
            ...
            <style>
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                /* Search and Filters */
                .controls { 
                    background: #f8fafc; padding: 25px; border-radius: 16px; margin-bottom: 30px;
                ...
                .search-input { 
                    width: 100%; padding: 12px 45px 12px 16px; border: 1px solid #d1d5db; 
                ...
                .filter-select { 
                    ...
                    background: white; font-size: 0.95rem; min-width: 150px;
                }
                ...
                .user-table th { 
                    ...
                    padding: 20px 16px; text-align: left; font-weight: 600; font-size: 0.9rem;
                    text-transform: uppercase; letter-spacing: 0.5px;
                }
                .user-table td { padding: 20px 16px; border-bottom: 1px solid #f1f5f9; }
                ...
                .user-name { font-weight: 600; color: #1a202c; margin-bottom: 2px; }
                .user-title { color: #64748b; font-size: 0.85rem; }
                ...
                .role-partner { background: #ede9fe; color: #7c3aed; }
                .role-managing-partner { background: #fef3c7; color: #d97706; }
                .role-senior-partner { background: #dbeafe; color: #2563eb; }
                .role-associate { background: #ecfdf5; color: #059669; }
                .role-senior-associate { background: #f0f9ff; color: #0284c7; }
                .role-junior-associate { background: #f0fdf4; color: #16a34a; }
                .role-paralegal { background: #fef2f2; color: #dc2626; }
                .role-senior-paralegal { background: #fdf2f8; color: #be185d; }
                .role-legal-assistant { background: #f8fafc; color: #475569; }
                .role-admin { background: #f0f9ff; color: #0284c7; }
                .role-it-admin { background: #ede9fe; color: #7c3aed; }
                .role-billing-admin { background: #ecfdf5; color: #059669; }
                .role-office-manager { background: #fef3c7; color: #d97706; }
                
                /* Permission Levels */
                .permission { font-size: 0.85rem; }
                .perm-full { color: #059669; font-weight: 600; }
                .perm-limited { color: #d97706; font-weight: 600; }
                .perm-basic { color: #64748b; font-weight: 600; }
                .perm-view-only { color: #dc2626; font-weight: 600; }
                ...
                @media (max-width: 768px) {
                    ...
                    .user-table th, .user-table td { padding: 12px 8px; font-size: 0.85rem; }
                ...
                .modal-content { 
                    background: white; margin: 5% auto; padding: 30px; width: 90%; max-width: 600px; 
            ...
            <div class="container">
                ...
                <div class="header">
                    <div>
                        ...
                        <p class="subtitle">Manage firm user accounts, roles, and permissions</p>
                    </div>
                    <div class="actions">
                ...
                <div class="stats">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-change positive">↗ 91.7% active</div>
                    </div>
                    <div class="stat-card">
                ...
                <div class="table-container">
                    <table class="user-table" id="userTable">
                        ...
                        <tbody>
                            <tr data-role="managing-partner" data-status="active">
                                <td>
                                    <div class="user-avatar">JD</div>
                                    <div class="user-info">
                                        <div class="user-name">John Doe</div>
                                        <div class="user-title">john.doe@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-managing-partner">Managing Partner</span></td>
                                <td><span class="badge status-active">Active</span></td>
                                <td><span class="permission perm-full">Full Access</span></td>
                                <td>2 hours ago</td>
                                <td>24 active</td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('john.doe')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-secondary" onclick="viewUser('john.doe')">👁️ View</button>
                                    </div>
                                </td>
                            </tr>
                            <tr data-role="senior-partner" data-status="active">
                                <td>
                                    <div class="user-avatar">JS</div>
                                    <div class="user-info">
                                        <div class="user-name">Jane Smith</div>
                                        <div class="user-title">jane.smith@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-senior-partner">Senior Partner</span></td>
                                <td><span class="badge status-active">Active</span></td>
                                <td><span class="permission perm-full">Full Access</span></td>
                                <td>1 hour ago</td>
                                <td>18 active</td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('jane.smith')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-secondary" onclick="viewUser('jane.smith')">👁️ View</button>
                                    </div>
                                </td>
                            </tr>
                            <tr data-role="senior-associate" data-status="active">
                                <td>
                                    <div class="user-avatar">BJ</div>
                                    <div class="user-info">
                                        <div class="user-name">Bob Johnson</div>
                                        <div class="user-title">bob.johnson@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-senior-associate">Senior Associate</span></td>
                                <td><span class="badge status-active">Active</span></td>
                                <td><span class="permission perm-limited">Limited Access</span></td>
                                <td>3 hours ago</td>
                                <td>12 active</td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('bob.johnson')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-secondary" onclick="viewUser('bob.johnson')">👁️ View</button>
                                    </div>
                                </td>
                            </tr>
                            <tr data-role="associate" data-status="active">
                                <td>
                                    <div class="user-avatar">SW</div>
                                    <div class="user-info">
                                        <div class="user-name">Sarah Wilson</div>
                                        <div class="user-title">sarah.wilson@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-associate">Associate</span></td>
                                <td><span class="badge status-active">Active</span></td>
                                <td><span class="permission perm-limited">Limited Access</span></td>
                                <td>5 hours ago</td>
                                <td>8 active</td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('sarah.wilson')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-secondary" onclick="viewUser('sarah.wilson')">👁️ View</button>
                                    </div>
                                </td>
                            </tr>
                            <tr data-role="junior-associate" data-status="pending">
                                <td>
                                    <div class="user-avatar">MB</div>
                                    <div class="user-info">
                                        <div class="user-name">Mike Brown</div>
                                        <div class="user-title">mike.brown@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-junior-associate">Junior Associate</span></td>
                                <td><span class="badge status-pending">Pending</span></td>
                                <td><span class="permission perm-basic">Basic Access</span></td>
                                <td>Never</td>
                                <td>0 assigned</td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('mike.brown')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-primary" onclick="activateUser('mike.brown')">✅ Activate</button>
                                    </div>
                                </td>
                            </tr>
                            <tr data-role="senior-paralegal" data-status="active">
                                <td>
                                    <div class="user-avatar">LD</div>
                                    <div class="user-info">
                                        <div class="user-name">Lisa Davis</div>
                                        <div class="user-title">lisa.davis@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-senior-paralegal">Senior Paralegal</span></td>
                                <td><span class="badge status-active">Active</span></td>
                                <td><span class="permission perm-basic">Basic Access</span></td>
                                <td>1 day ago</td>
                                <td>15 supporting</td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('lisa.davis')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-secondary" onclick="viewUser('lisa.davis')">👁️ View</button>
                                    </div>
                                </td>
                            </tr>
                            <tr data-role="paralegal" data-status="active">
                                <td>
                                    <div class="user-avatar">TG</div>
                                    <div class="user-info">
                                        <div class="user-name">Tom Garcia</div>
                                        <div class="user-title">tom.garcia@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-paralegal">Paralegal</span></td>
                                <td><span class="badge status-active">Active</span></td>
                                <td><span class="permission perm-basic">Basic Access</span></td>
                                <td>6 hours ago</td>
                                <td>7 supporting</td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('tom.garcia')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-secondary" onclick="viewUser('tom.garcia')">👁️ View</button>
                                    </div>
                                </td>
                            </tr>
                            <tr data-role="legal-assistant" data-status="active">
                                <td>
                                    <div class="user-avatar">AM</div>
                                    <div class="user-info">
                                        <div class="user-name">Anna Martinez</div>
                                        <div class="user-title">anna.martinez@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-legal-assistant">Legal Assistant</span></td>
                                <td><span class="badge status-active">Active</span></td>
                                <td><span class="permission perm-view-only">View Only</span></td>
                                <td>4 hours ago</td>
                                <td>3 supporting</td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('anna.martinez')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-secondary" onclick="viewUser('anna.martinez')">👁️ View</button>
                                    </div>
                                </td>
                            </tr>
                            <tr data-role="it-admin" data-status="active">
                                <td>
                                    <div class="user-avatar">KL</div>
                                    <div class="user-info">
                                        <div class="user-name">Kevin Lee</div>
                                        <div class="user-title">kevin.lee@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-it-admin">IT Administrator</span></td>
                                <td><span class="badge status-active">Active</span></td>
                                <td><span class="permission perm-full">Full Access</span></td>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('kevin.lee')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-secondary" onclick="viewUser('kevin.lee')">👁️ View</button>
                                    </div>
                                </td>
                            </tr>
                            <tr data-role="billing-admin" data-status="active">
                                <td>
                                    <div class="user-avatar">RT</div>
                                    <div class="user-info">
                                        <div class="user-name">Rachel Taylor</div>
                                        <div class="user-title">rachel.taylor@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-billing-admin">Billing Admin</span></td>
                                <td><span class="badge status-active">Active</span></td>
                                <td><span class="permission perm-limited">Limited Access</span></td>
                                <td>2 hours ago</td>
                                <td>Billing Only</td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('rachel.taylor')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-secondary" onclick="viewUser('rachel.taylor')">👁️ View</button>
                                    </div>
                                </td>
                            </tr>
                            <tr data-role="office-manager" data-status="active">
                                <td>
                                    <div class="user-avatar">DW</div>
                                    <div class="user-info">
                                        <div class="user-name">David White</div>
                                        <div class="user-title">david.white@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-office-manager">Office Manager</span></td>
                                <td><span class="badge status-active">Active</span></td>
                                <td><span class="permission perm-limited">Limited Access</span></td>
                                <td>1 hour ago</td>
                                <td>Office Admin</td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('david.white')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-secondary" onclick="viewUser('david.white')">👁️ View</button>
                                    </div>
                                </td>
                            </tr>
                            <tr data-role="associate" data-status="inactive">
                                <td>
                                    <div class="user-avatar">CS</div>
                                    <div class="user-info">
                                        <div class="user-name">Chris Stone</div>
                                        <div class="user-title">chris.stone@lawfirm.com</div>
                                    </div>
                                </td>
                                <td><span class="badge role-associate">Associate</span></td>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn btn-sm btn-edit" onclick="editUser('chris.stone')">✏️ Edit</button>
                                        <button class="btn btn-sm btn-primary" onclick="reactivateUser('chris.stone')">🔄 Reactivate</button>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <form id="addUserForm">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-input" id="userRole" required>
                                ...
                                <option value="billing-admin">Billing Administrator</option>
                                <option value="office-manager">Office Manager</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Permission Level</label>
                            <select class="form-input" id="userPermissions" required>
            ...
            <script>
                ...
                function activateUser(userId) {
                    if (confirm('Activate user: ' + userId + '?')) {
                        ...
                        // In real implementation, make API call to activate user
                    }
                }

                function reactivateUser(userId) {
                    if (confirm('Reactivate user: ' + userId + '?')) {
                        alert('User reactivated successfully!');
                        // In real implementation, make API call to reactivate user
                    }
                }

                function exportUsers() {
                    alert('Exporting user data...\\nThis would generate a CSV/Excel file with all user information.');
                }
...
def admin_settings():
    """Admin settings page"""
    try:
        # Mock user data for settings page
        user = {
            'first_name': 'System',
            'last_name': 'Settings',
            'email': 'settings@lexai.com',
            'phone': '(555) 123-4567',
            'firm_name': 'Demo Law Firm',
            'job_title': 'System Configuration',
            'role': 'Admin',
            'bar_number': 'SETTINGS',
            'bio': 'System settings and configuration management.'
        }
        return render_template('user_profile.html', user=user, page_title='System Settings')
    except Exception as e:
...
def admin_subscriptions():
    ...
    try:
        # Mock user data for subscriptions page
        user = {
            'first_name': 'Subscription',
            'last_name': 'Manager',
            'email': 'billing@lexai.com',
            'phone': '(555) 123-4567',
            'firm_name': 'Demo Law Firm',
            'job_title': 'Billing Administrator',
            'role': 'Admin',
            'bar_number': 'BILLING',
            'bio': 'Managing subscriptions and billing information.'
        }
        return render_template('user_profile.html', user=user, page_title='Subscription Management')
    except Exception as e:
